...
class calci extends ext_calci{
    ...
    public static void main(String[] args){
        ...
        float sq=calc.square(operand_1);
        System.out.println("Result of Square is: " + sq);
       float  cu=calc.cube(operand_2);
       System.out.println("Result of Cube is: " + cu);
